    ...
    items: [
      {
        ...
        link: "#",
        children: [
          { title: "Admin", link: "/team-structure/admin" },
          { title: "ABM", link: "/team-structure/abm" },
          { title: "ABE", link: "/team-structure/abe" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        link: "#",
        children: [
          { title: "Pull APIs", link: "/automation/pull-apis" },
          { title: "Push APIs", link: "/automation/push-apis" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { title: "Lead RecycleBin", link: "/lead/recyclebin" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        link: "#",
        children: [
          { title: "Create Email", link: "/users/all-users" },
          { title: "Email History", link: "/users/blocked-users" },
          { title: "Bulk Template", link: "/users/blocked-users" },
          { title: "Bulk Sms&Email List", link: "/users/blocked-users" },
        ],
      },
    ],
  },
