          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
            ...
            <div className="flex flex-col gap-1">
               <div className="flex justify-between items-center mb-1">
                 <label className="font-semibold text-[12px] text-gray-500 uppercase tracking-wider">HSN Code</label>
                 <button className="text-[10px] bg-[#6c87e0] text-white px-2 py-0.5 rounded shadow-sm">Find HSN Code</button>
               </div>
            ...
            <Input label="Discount (In Percent)" placeholder="0" type="number" />
            ...
            <div className="flex flex-col gap-1">
               <label className="font-semibold mb-1 text-[12px] text-gray-500 uppercase tracking-wider">Product Image</label>
