...
const LeadReport = () => {
  const columns = [
    ...
    {
      label: <span className="text-[#28a745]">Interested</span>,
      key: "interested",
    },
    {
      label: <span className="text-[#e83e8c]">Call Back</span>,
      key: "callback",
    },
    {
      label: <span className="text-[#17a2b8]">No Requirement</span>,
      key: "noReq",
    },
    {
      label: <span className="text-[#6f42c1]">Follow Up</span>,
      key: "followUp",
    },
  ];
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm mb-6 p-10 relative overflow-hidden">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-400 text-xs mt-1">
            Distribution of leads in different categories
          </p>
        </div>
...
const GraphNode = ({ color, label, value, isCenter }) => (
  <div className="relative flex flex-col items-center group">
    <span className="absolute -top-7 font-bold text-xs text-black">
      {value}
    </span>
    {isCenter && (
