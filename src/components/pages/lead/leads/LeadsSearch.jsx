    ...
    <div className="w-full bg-white p-6 rounded-sm shadow-sm border border-gray-100">
      <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <Input label="Select User" type="select" placeholder="Select Users" options={userOptions} labelKey="name" valueKey="id" />
          <Input label="Select Branch" type="select" placeholder="-Select Branch-" options={[]} />
          <Input label="Select Source" type="select" placeholder="-Select Source-" options={[]} />
          <Input label="Reference" type="text" placeholder="Reference" />
        </div>

        {/* ROW 2 */}
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <Input label="Users" type="select" options={leadOptions} labelKey="name" valueKey="id" />
          <Input type="select" placeholder="-Select Date-" options={[]} />
          <Input type="select" placeholder="-Select Country-" options={countryOptions} labelKey="name" valueKey="id" />
          <Input type="select" placeholder="-Select State-" options={stateOptions} labelKey="name" valueKey="id" />
          <Input type="select" placeholder="-Select City-" options={cityOptions} labelKey="name" valueKey="id" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <Input type="select" placeholder="-select priority-" options={priorityOptions} labelKey="name" valueKey="id" />
